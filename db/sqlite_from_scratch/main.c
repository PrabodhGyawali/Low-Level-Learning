...
void* get_page(Pager* pager, uint32_t page_num) {
    ...
    // Page Num greater than file_length / ROW_SIZE???
...
PrepareResult do_prepare_statement(InputBuffer* input_buffer, Statement* statement) {
...
int main(int argc, char *argv[]) {
    ...
    while(1) {
        ...
        switch(do_prepare_statement(input_buffer, &statement)) {
